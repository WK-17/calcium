classdef GCampsAnalysisApp_cp_Final_for_baseline_correction_exportedApp < handle
    %
    % Usage:
    %     app.GCampsAnalysisApp_cp_Final_for_baseline_correction_exportedApp
    ...
    properties (Constant)
        AppPathBase = {'/GCampsAnalysisApp_cp_Final_for_baseline_correction_exported'};
        AppClass = 'GCampsAnalysisApp_cp_Final_for_baseline_correction_exportedApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = GCampsAnalysisApp_cp_Final_for_baseline_correction_exportedApp()
        ...
        function startApp(obj)
            ...
            mlock;
            GCampsAnalysisApp_cp_Final_for_baseline_correction_exportedApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'GCampsAnalysisApp_cp_Final_for_baseline_correction_exported')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong GCampsAnalysisApp_cp_Final_for_baseline_correction_exported
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'GCampsAnalysisApp_cp_Final_for_baseline_correction_exported').getString, ...
            ...
            if nargout(@GCampsAnalysisApp_cp_Final_for_baseline_correction_exported) == 0
                eval('GCampsAnalysisApp_cp_Final_for_baseline_correction_exported');
            else
                obj.AppHandle = eval('GCampsAnalysisApp_cp_Final_for_baseline_correction_exported');
            end
